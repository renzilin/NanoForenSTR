...
def needle(seq1, seq2, match_award = 10, mismatch_penalty = -5, gap_penalty = -5):
    ...
    identity, score, align1, align2 = finalize(align1, align2, match_award, mismatch_penalty, gap_penalty)
    return identity, score, align1, align2



def water(seq1, seq2, match_award = 10, mismatch_penalty = -2, gap_penalty = -5):
    m, n = len(seq1), len(seq2)  # length of two sequences
